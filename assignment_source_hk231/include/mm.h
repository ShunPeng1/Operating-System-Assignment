...
/* Error code */
/* ALLOC */
#define ERR_AREA_OVERLAP -1
#define ERR_LACK_MEM_RAM -2
#define ERR_LACK_MEM_SWP -3

/* READ/WRITE*/
#define ERR_INVALID_ACCESS -1
#define ERR_SWAPPING -2
#define ERR_RW_UNDEFINED -3
...
// Quang added this
int enlist_tail_pgn_node(struct pgn_t **pgnlist, int pgn);
// End of Quang
